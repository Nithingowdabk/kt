...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($duration)) {
        ...
        try {
            ...
            if (empty($error)) {
                // Update Trek details
                $stmt = $db->prepare("UPDATE treks SET 
                    category_id = ?, title = ?, slug = ?, duration = ?, difficulty = ?, 
                    trek_distance = ?, altitude = ?, price = ?, offer_price = ?, 
                    with_transport_price = ?, with_transport_offer_price = ?,
                    ...
                    meta_title = ?, meta_description = ?, focus_keyphrase = ?, excerpt = ?, image_alt = ?, tags = ?, image = ? WHERE id = ?");
                ...
                $stmt->execute([
                    ...
                    $distance,
                    $altitude,
                    $with_transport_price, // fallback legacy support
                    $with_transport_offer_price, // fallback legacy support
                ...
                <div class="admin-card">
                    ...
                    <div class="row g-3 mb-4 border-top pt-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="pickup_points_txt" class="form-control" value="<?php echo htmlspecialchars($trek['pickup_points_txt'] ?? ''); ?>">
                        </div>
